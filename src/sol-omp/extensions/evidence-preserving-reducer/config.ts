...
export const REDUCER_EVENT_TYPE = "sol-omp-evidence-preserving-reducer-v1" as const;
export const REDUCER_EVENT_SCHEMA = "sol-omp-evidence-preserving-reducer/1" as const;
export const REDUCER_RECEIPT_SCHEMA = "sol-omp-evidence-receipt/1" as const;
export const REDUCER_RECEIPT_PREFIX = "sol_omp_evidence_receipt_v1" as const;
